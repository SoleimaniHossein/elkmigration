...
func ExportDocuments(ctx context.Context, config *config.Config, elk2client clients.ElasticsearchClient, elk8Client clients.ElasticsearchClient, docs chan<- *elastic.SearchResult, redis *clients.RedisClient) {
	defer close(docs)
